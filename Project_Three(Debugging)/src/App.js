...
const App = () => {
  ...
  const addGoalHandler = enteredText => {
    setCourseGoals(prevGoals => {
      ...
      //in the added new goald the id was sanme for all so it deleted the 1st occured element of the array.
  ...
  return (
      ...
      // Bug 1. Added div tag because it was having 2 section tag side by side
